...
<div id="mySidenav" class="sidenav">
 <a href="assets/rulebook.pdf" target="_blank" id="sticky-rulebook">Rule Book</a>
 <a href="assets/timetable.pdf" target="_blank" id="sticky-timetable">Logistics</a>
</div>
...
<section id="hero-section" >
  <div class="" align=center>
    ...
    <h3 id="header-subtext">4th-5th Jan, 2019</h3>
  </div>
</section>
      ...
      <div class="col wow slideInLeft">
        <div class="card tech-card gradient-shadow">
          ...
          <div class="card-body">
            ...
            <a href="#" name="event1" data-toggle="modal" data-event="Code Mapper" data-target="#eventsModal" id="Event1" class="btn Tech gradient-button">know more</a>
          </div>
        </div>
      </div>
      <!-- Event 2 -->
            ...
            <div class="card text-center price-card">
              ...
              <div class="option">
                <ul>
                  ...
                  <li>Prize: Certificate + Goodies/Cash Prizes</li>
                </ul>
              </div>
...
<div>
  ...
  <div class="row sub-row" align=center>
      ...
      <div class="card-container">
        ...
        <div class="card card-back">
          <div class="card-body">
            ...
            <a href="#" name="subEvent" data-toggle="modal" data-event="CS:GO" data-target="#regClosed" class="btn Sub gradient-button">Know More</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3 wow flipInX">
      <div class="card-container">
        <div class="card card-front">
          <img class="card-img-top" src="assets\images\sub-events\FIFA19.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="sub-card-title card-title">FIFA19</h5>
          </div>
        </div>
        <div class="card card-back">
          <div class="card-body">
            <h5 class="card-title">FIFA19</h5>
            <p class="card-text">
              A LAN Gaming Event.
            </p>
            <a href="#" name="subEvent" data-toggle="modal" data-event="FIFA19" data-target="#eventsModal" class="btn Sub gradient-button">Know More</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row sub-row" align=center>
    ...
    <div class="col-md-3 wow flipInX">
      <div class="card-container">
        <div class="card card-front">
          <img class="card-img-top" src="assets\images\sub-events\instrumental.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="sub-card-title card-title">Instrumental</h5>
          </div>
        </div>
        <div class="card card-back">
          <div class="card-body">
            ...
            <p class="card-text">
              Beat the drums, tune in to your guitar, feel the music!
            </p>
            <a href="#" name="subEvent" data-toggle="modal" data-event="Instrumental" data-target="#eventsModal" class="btn Sub gradient-button">Know More</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3 wow flipInX">
      <div class="card-container">
        <div class="card card-front">
          <img class="card-img-top" src="assets\images\sub-events\PPT Presentation.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="sub-card-title card-title">PPT Presentation</h5>
          </div>
        </div>
        <div class="card card-back">
          <div class="card-body">
            <h5 class="card-title">PPT Presentation</h5>
            <p class="card-text">
              Present a PPT to showcase your communication and interaction skills! 
            </p>
            <a href="#" name="subEvent" data-toggle="modal" data-event="PPT Competition" data-target="#eventsModal" class="btn Sub gradient-button">Know More</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3 wow flipInX">
      <div class="card-container">
        <div class="card card-front">
          ...
          <div class="card-body">
            <h5 class="sub-card-title card-title">Rubik's Cube</h5>
          </div>
        </div>
        <div class="card card-back">
          <div class="card-body">
            ...
            <p class="card-text">
              Solve a 3x3 Rubik's Cube as fast as you can!
            </p>
            <a href="#" name="subEvent" data-toggle="modal" data-event="Rubiks Cube" data-target="#eventsModal" class="btn Sub gradient-button">Know More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="sponsors" class="sponsors">
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="imgBx">
            <img src="assets\images\Sponsors\study_chakra.png">
          </div>
          <div class="details">
            <h3>Study Chakra<br><span>Your study partner!</span></h3>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="imgBx">
            <img src="assets\images\Sponsors\GIIT.jpg">
          </div>
          <div class="details">
            <h3>Garuda Institute of Information Technology<br><span>GIIT</span></h3>
          </div>
        </div>
      </div>
      <!-- Add Pagination -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Registrations for this event are full.</p>
      </div>
      <div class="modal-footer">

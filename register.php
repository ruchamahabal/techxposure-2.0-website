...
<div class=" register">
  <div class="row">
    ...
    <div class="col-md-9 register-right">
      ...
      <form action="admin/solo.php" method="POST">
        ...
        <div class="col-md-6">
            <span id="form-event-hint"><small>*Multiple events can be selected by pressing ctrl or dragging mouse</small></span>
          <div class="form-group">
  ...
  <div class="row register-form">
      ...
      <div class="col-md-6">
          <div class="form-group">
              <input type="text" name="numberOfMembers" min="0" max="5" class="form-control" placeholder="Number of Members (Max 5)*" value=""  required/>
          </div>
          <div class="form-group">

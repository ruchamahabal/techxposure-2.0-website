...
// OPTIONAL SETTING
$redirect_url = '../register.php?RegistrationSuccessful'; // Example: http://domain.com/thankyou.html - must be a FULL URL.
...
break;
endswitch;
if (strtolower($field) != 'redirect' AND strtolower($field) != 'submit' AND strtolower($field) != 'subject' AND strtolower($field) != 'teamevents'):
